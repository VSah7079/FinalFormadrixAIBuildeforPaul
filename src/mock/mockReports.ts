...
// ─────────────────────────────────────────────────────────────────────────────
// One FullReport per worklist case (S26-4401 … S26-4460).
...
const reports: FullReport[] = [
  ...
  full('S26-4401','Miller, Jane','Female','MRN-881042','1968-03-14','2026-02-24T08:00:00Z',
    ...
    'Received fresh is a left breast mastectomy specimen weighing 312 g, measuring 18 × 14 × 4 cm. Serial sectioning reveals a firm, white-tan stellate mass in the upper outer quadrant measuring 2.3 × 1.8 × 1.5 cm, located 3 cm from the nipple.',
  ...
  full('S26-4402','Smith, Alice','Female','MRN-334817','1954-07-22','2026-02-25T09:15:00Z',
    ...
    'Received fresh is a wedge resection of right upper lobe measuring 7 × 5 × 2 cm with an overlying pleural surface. Sectioning reveals a 1.9 cm grey-white subpleural nodule with focal pleural puckering.',
  ...
  full('S26-4405','Davis, Robert','Male','MRN-556230','1949-11-03','2026-02-25T10:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Right hemicolectomy specimen measuring 28 cm in length including 6 cm terminal ileum. A 4.1 × 3.2 cm ulcerated tumour is identified in the ascending colon, 8 cm from the ileocaecal valve. Tumour penetrates through the muscularis propria into pericolorectal fat.',
  ...
  full('S26-4410','Wilson, Karen','Female','MRN-772914','1958-05-09','2026-02-24T08:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Radical prostatectomy specimen weighing 48 g, measuring 4.2 × 3.8 × 3.1 cm. Seminal vesicles are intact. Inked and serially sectioned at 3 mm intervals. Tumour involves bilateral lobes predominantly in the posterior mid and apex regions.',
  ...
  full('S26-4412','Johnson, Michael','Male','MRN-119087','1972-09-17','2026-02-23T09:00:00Z',
    ...
    'Lumpectomy specimen measuring 5.5 × 4.2 × 3.1 cm. Serial sectioning reveals an ill-defined firm area in the central portion measuring approximately 1.6 cm. Margins inked per protocol.',
  ...
  full('S26-4415','Thompson, Grace','Female','MRN-443561','1965-02-28','2026-02-25T08:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Total thyroidectomy specimen weighing 34 g. Right lobe 5.2 × 3.1 × 2.4 cm, left lobe 4.8 × 2.9 × 2.1 cm, isthmus 1.2 cm. A 2.8 cm well-circumscribed pale nodule is identified in the right lobe.',
  ...
  full('S26-4416','Martinez, Carlos','Male','MRN-887234','1980-06-11','2026-02-25T10:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Elliptical skin excision measuring 5.2 × 3.8 cm with underlying subcutaneous fat to depth of 1.2 cm. A 1.4 × 0.9 cm asymmetric brown-black pigmented lesion is identified centrally.',
    'Sections show malignant melanoma, superficial spreading type, with radial and vertical growth phases. Breslow thickness 1.8 mm. Clark level IV (invasion into reticular dermis). Mitotic rate 3/mm². Lymphovascular invasion present. Ulceration absent. Regression absent. All excision margins negative.',
  ...
  full('S26-4417','Lee, Sung-Min','Male','MRN-224789','1961-12-04','2026-02-25T11:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Partial nephrectomy specimen measuring 8.1 × 6.3 × 4.2 cm including perinephric fat. Sectioning reveals a well-circumscribed golden-yellow tumour measuring 5.2 × 4.8 × 4.1 cm with focal haemorrhage and a thin fibrous pseudocapsule.',
    'Sections show clear cell renal cell carcinoma with diffuse sheet-like architecture and abundant clear cytoplasm reflecting glycogen and lipid content. ISUP grade 2 (nucleoli inconspicuous at 400×). No sarcomatoid or rhabdoid differentiation. Tumour confined to kidney (pT1b). Parenchymal resection margin negative (closest 2 mm).',
  ...
  full('S26-4418','Patel, Priya','Female','MRN-991023','1975-08-19','2026-02-24T09:00:00Z',
    ...
    'Total abdominal hysterectomy with bilateral salpingo-oophorectomy. Uterus weighs 142 g, measures 9.2 × 5.8 × 4.1 cm. Endometrium measures up to 1.4 cm in thickness. An exophytic polypoid lesion measuring 2.8 × 2.1 cm is identified in the fundus.',
  ...
  full('S26-4420','Garcia, Isabella','Female','MRN-773421','1989-01-30','2026-02-25T08:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'LEEP cone specimen measuring 2.4 × 2.2 × 1.8 cm. Ectocervical margin inked blue, endocervical margin inked black. Serial sections submitted in 12 cassettes with clock-face orientation.',
  ...
  full('S26-4421','Anderson, Paul','Male','MRN-112985','1957-10-07','2026-02-24T09:30:00Z',
    ...
    'Three liver core biopsies received in formalin, each measuring 1.5–1.8 cm.',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Three tan-white core biopsies each measuring 1.5–1.8 cm in length and 0.2 cm in diameter. Submitted entirely in 2 cassettes.',
    ...
    'CK20 positive, CK7 negative, CDX2 positive, TTF-1 negative — immunophenotype consistent with colorectal origin. MMR IHC: MLH1 loss detected, PMS2 loss detected (MLH1 promoter methylation analysis pending).'),
  ...
  full('S26-4422','White, Eleanor','Female','MRN-664837','1966-06-16','2026-02-25T09:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Left oophorectomy specimen measuring 8.1 × 6.8 × 5.2 cm. External surface is bosselated with a focal area of capsule disruption. Sectioning reveals solid and cystic architecture with papillary excrescences and areas of haemorrhage and necrosis.',
  ...
  full('S26-4425','Lewis, Nathan','Male','MRN-445219','1952-08-03','2026-02-24T09:15:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Radical orchiectomy specimen: testis measuring 5.8 × 4.2 × 3.6 cm with attached spermatic cord 8 cm in length. Sectioning reveals a homogeneous cream-coloured lobulated tumour replacing most of the testis, measuring 3.8 × 3.2 × 2.9 cm. Tunica albuginea intact.',
  ...
  full('S26-4426','Robinson, Faye','Female','MRN-997643','1963-04-08','2026-02-25T10:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Superficial parotidectomy specimen measuring 5.8 × 4.2 × 2.9 cm. Sectioning reveals a well-circumscribed nodule with a thin capsule measuring 3.1 × 2.8 × 2.4 cm. Cut surface shows chondromyxoid stroma with firm white-grey areas.',
  ...
  full('S26-4427','Walker, Jerome','Male','MRN-221874','1948-07-14','2026-02-23T11:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Four polypectomy specimens labelled A–D. Polyp A: 0.6 cm sessile. Polyp B: 0.8 cm pedunculated. Polyp C: 0.7 cm sessile. Polyp D: 1.8 cm pedunculated with long stalk.',
    'Polyps A–C: tubular adenoma with low grade dysplasia, complete excision. Polyp D: tubulovillous adenoma (villous component 35%) with focal high grade dysplasia, no invasive carcinoma. Stalk resection margin clear (>2 mm). No lymphovascular invasion.',
  ...
  full('S26-4428','Young, Angela','Female','MRN-664028','1970-09-26','2026-02-25T09:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Excision specimen measuring 12.1 × 9.4 × 7.8 cm. Sectioning reveals a bi-phasic tumour with a yellow lipomatous component (well-differentiated liposarcoma, 60%) and a firm grey-white non-lipogenic component (dedifferentiated, 40%) measuring up to 9.4 cm.',
  ...
  full('S26-4429','Allen, Thomas','Male','MRN-332956','1945-02-17','2026-02-24T08:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Partial gastrectomy specimen measuring 22 cm along lesser curvature and 28 cm along greater curvature. An ulcerated tumour measuring 4.8 × 3.9 cm with raised everted edges is identified in the antrum, 3.1 cm from the proximal resection margin.',
  ...
  full('S26-4431','Scott, Raymond','Male','MRN-119462','1956-10-22','2026-02-23T09:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    '12 individually labelled core biopsies each measuring 1.2–1.8 cm in length. Submitted by anatomic site in 12 cassettes.',
  ...
  full('S26-4432','Green, Harriet','Female','MRN-774823','1982-01-07','2026-02-24T10:15:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Bilateral salpingectomy: right tube measuring 6.8 × 0.8 cm, left tube measuring 7.2 × 0.9 cm. Fimbriated ends submitted by SEE-FIM protocol.',
  ...
  full('S26-4433','Adams, Victor','Male','MRN-446298','1961-07-18','2026-02-25T11:00:00Z',
    ...
    'Sections show a highly cellular glial neoplasm with marked nuclear pleomorphism, brisk mitotic activity (>10/10 HPF), microvascular proliferation (glomeruloid), and geographic necrosis with pseudopalisading — consistent with glioblastoma. Infiltration of adjacent brain parenchyma.',
  ...
  full('S26-4434','Baker, Monica','Female','MRN-992847','1977-03-13','2026-02-24T09:45:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Wide local excision measuring 4.8 × 3.6 × 2.1 cm. A 1.9 × 1.4 cm ulcerated lesion is identified on the right labia minora. Depth of invasion 8 mm.',
  ...
  full('S26-4435','Gonzalez, Enrique','Male','MRN-115673','1950-11-29','2026-02-25T08:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Oesophagogastrectomy specimen, oesophagus 12 cm and stomach 8 cm. Ulcerated tumour in distal oesophagus measuring 5.2 × 4.1 cm, located at the gastro-oesophageal junction, 2 cm above the Z-line.',
  ...
  full('S26-4436','Nelson, Betty','Female','MRN-337814','1940-05-06','2026-02-23T10:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Elliptical skin excision measuring 3.2 × 2.4 cm from the nasal dorsum, depth 0.6 cm. A 1.1 × 0.8 cm pearly papule with telangiectasia is identified centrally.',
  ...
  full('S26-4437','Carter, Denise','Female','MRN-883021','1969-02-14','2026-02-25T09:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Two core biopsies each measuring 1.4 cm × 2 mm. Entirely submitted.',
  ...
  full('S26-4438','Mitchell, Franklin','Male','MRN-441397','1955-08-30','2026-02-24T08:30:00Z',
    ...
    'Diffuse large B-cell lymphoma, NOS','Not applicable (lymphoma)','Spleen 14.8 × 11.2 × 7.3 cm','Not applicable','Present',
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Splenectomy specimen weighing 680 g, measuring 14.8 × 11.2 × 7.3 cm. Capsule intact. Sectioning reveals multiple confluent grey-white nodules replacing much of the splenic parenchyma, largest measuring 6.2 cm.',
  ...
  full('S26-4439','Perez, Luisa','Female','MRN-776952','1986-12-01','2026-02-25T10:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Bilateral trephine biopsies each measuring 1.8–2.2 cm in length and 0.2 cm in diameter, adequate for assessment.',
    'Sections show hypercellular marrow (>90% cellularity) with marked reduction in normal trilineage haematopoiesis. Blasts comprising approximately 35–40% of nucleated cells by morphology, with CD34 IHC confirming blast percentage. Dysplastic megakaryocytes and dyserythropoiesis noted.',
  ...
  full('S26-4440','Roberts, Clarence','Male','MRN-113628','1944-06-23','2026-02-25T08:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Whipple resection specimen: pancreatic head 5.8 × 4.2 × 3.1 cm, duodenum 22 cm, common bile duct 3.2 cm. Sectioning reveals a firm white-grey ill-defined mass in the pancreatic head/uncinate measuring 3.4 × 2.9 cm obstructing the main pancreatic duct.',
  ...
  full('S26-4441','Turner, Sylvia','Female','MRN-558034','1991-04-09','2026-02-22T09:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Three tissue fragments each measuring 3–5 mm. Entirely submitted.',
  ...
  full('S26-4443','Campbell, Rosemary','Female','MRN-221546','1974-07-27','2026-02-24T10:00:00Z',
    ...
    'Four tan-white core biopsies each measuring 1.4–1.8 cm in length, entirely submitted.',
  ...
  full('S26-4444','Parker, Leonard','Male','MRN-667803','1946-03-04','2026-02-25T08:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Left hemicolectomy specimen measuring 32 cm in length. Annular ulcerated tumour in descending colon measuring 6.1 × 5.2 cm penetrating through the serosa with visible tumour on peritoneal surface.',
    ...
    'CK20, CDX2, MUC2 positive. CK7 negative. MMR IHC: MLH1 and PMS2 loss (MLH1 promoter methylation detected — likely sporadic MSI-H). KRAS G12D mutation detected. BRAF V600E: wildtype. RAS/RAF profiling complete.'),
  ...
  full('S26-4445','Evans, Constance','Female','MRN-442917','1983-10-16','2026-02-22T10:00:00Z',
    ...
    'Melanoma in situ (lentigo maligna type) — both lesions',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Two shave biopsy specimens: Lesion A measuring 1.4 × 1.1 cm, Lesion B measuring 0.9 × 0.7 cm, each to depth of 2 mm.',
  ...
  full('S26-4446','Edwards, Wallace','Male','MRN-119384','1953-12-20','2026-02-25T09:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Radical cystectomy with prostate: bladder 9.2 × 8.1 × 4.8 cm. Dominant posterior wall tumour 5.8 × 4.9 cm with areas of necrosis invading through perivesical fat.',
  ...
  full('S26-4447','Collins, Marguerite','Female','MRN-885627','1979-06-03','2026-02-24T09:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Right adrenalectomy specimen weighing 94 g, measuring 7.2 × 6.4 × 5.1 cm. Sectioning reveals a heterogeneous tumour with haemorrhage, necrosis, and fibrous bands.',
  ...
  full('S26-4448','Stewart, Reginald','Male','MRN-443081','1960-01-11','2026-02-24T10:30:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Left lower lobectomy specimen measuring 14 × 9 × 4 cm. Sectioning reveals a 3.1 × 2.7 cm white-grey central tumour with a hilar location, partially obstructing a segmental bronchus.',
  ...
  full('S26-4449','Sanchez, Olivia','Female','MRN-776134','1988-07-24','2026-02-22T09:30:00Z',
    'Myomectomy Specimen',
    'Myomectomy specimen — multiple fibroids received.',
    'Uterine leiomyoma (x4), largest with hyaline degeneration — no evidence of malignancy',
    'Leiomyoma (benign)','Benign','Largest 7.2 cm','Not applicable','Not identified',
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Four fibroid specimens received. Largest measuring 7.2 × 6.8 × 5.9 cm, firm, white whorled on cut section. Remaining three measuring 3.1 cm, 2.4 cm, and 1.8 cm.',
  ...
  full('S26-4450','Morris, Clifford','Male','MRN-112839','1962-04-17','2026-02-25T08:45:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Composite resection including right tonsil and base of tongue, measuring 5.8 × 4.1 × 3.2 cm overall. A 2.6 cm ill-defined firm area is identified at the base of tongue.',
  ...
  full('S26-4451','Rogers, Nadine','Female','MRN-887462','1971-08-08','2026-02-24T09:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Elliptical skin excision from right auricle measuring 4.1 × 3.0 cm with depth 0.9 cm. A 1.8 × 1.4 cm ulcerated lesion with rolled edges is identified centrally.',
  ...
  full('S26-4452','Reed, Douglas','Male','MRN-334095','1959-02-26','2026-02-25T09:15:00Z',
    ...
    'Right skin-sparing mastectomy weighing 498 g. Sectioning reveals a firm ill-defined white-grey tumour in the upper inner quadrant measuring 2.9 × 2.4 × 2.1 cm, located 4.2 cm from the nipple.',
    ...
    'ER 0% negative, PR 0% negative, HER2 3+ IHC positive. HER2 FISH: amplified (ratio 6.8). Ki-67 75%. Anti-HER2 therapy (trastuzumab + pertuzumab ± neratinib) eligibility: positive. Germline BRCA1/2 testing recommended given triple-negative-like profile.'),
  ...
  full('S26-4453','Cook, Patricia','Female','MRN-661834','1948-10-31','2026-02-22T10:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Cholecystectomy specimen measuring 8.2 × 3.8 × 2.4 cm. Mucosal surface shows a 1.2 × 0.9 cm sessile polypoid lesion in the fundus. Remaining mucosa granular and bile-stained.',
    ...
    'CK7 and CK19 positive. CDX2 focal positive. CA19-9 positive. No evidence of high-grade dysplasia in adjacent mucosa. Cholesterol polyp component also present. Incidental finding — recommend surgical oncology review.'),
  ...
  full('S26-4454','Morgan, Elliott','Male','MRN-997216','1967-05-14','2026-02-24T08:45:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Right radical nephrectomy weighing 624 g. Kidney 12.1 × 7.8 × 5.9 cm with perirenal fat. A 8.4 × 7.2 cm golden-yellow tumour with haemorrhage and necrosis is identified in the upper pole, with tumour thrombus extending into the main renal vein.',
    'Sections show ISUP grade 3 clear cell renal cell carcinoma (prominent nucleoli visible at 100×). Tumour extends into renal vein (pT3a). No adrenal gland involvement. Gerota fascia intact. Lymphovascular invasion (renal vein). Sarcomatoid differentiation: absent. Renal sinus fat not involved.',
    'CA9 diffusely positive. CD10 positive. PAX8 positive. CAIX positive. VHL mutation detected. BAP1 loss by IHC — adverse prognostic marker. Ki-67 18%.'),
  ...
  full('S26-4455','Bell, Adrienne','Female','MRN-442758','1984-11-07','2026-02-25T10:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Three core biopsies each measuring 1.5–2.0 cm in length. Entirely submitted.',
  ...
  full('S26-4456','Murphy, Cecilia','Female','MRN-118493','1993-03-22','2026-02-24T09:00:00Z',
    ...
    'HSIL (CIN 2–3)','Not applicable','Not applicable (biopsy)','Endocervical margin positive','Not identified',
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'LEEP cone measuring 2.1 × 1.8 × 1.4 cm. ECC: fragments of tan tissue 0.6 cm aggregate. Submitted separately.',
  ...
  full('S26-4457','Bailey, Wendell','Male','MRN-665317','1951-09-19','2026-02-25T08:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Radical prostatectomy weighing 62 g, 4.8 × 4.2 × 3.6 cm. Bilateral seminal vesicles. Sectioning shows bilateral posterior tumour with focal extraprostatic extension at right posterolateral apex.',
  ...
  full('S26-4458','Rivera, Camila','Female','MRN-883714','1995-06-28','2026-02-24T10:00:00Z',
    ...
    'Mature cystic teratoma (dermoid cyst) with incidental focus of struma ovarii — benign',
    'Mature cystic teratoma (dermoid cyst)','Benign','7.1 cm (cyst)','Not applicable','Not identified',
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Right salpingo-oophorectomy: ovary 8.3 × 7.1 × 6.2 cm. Unilocular cyst with yellow-green sebaceous material and hair. Nodular area (Rokitansky nodule) 1.8 cm.',
  ...
  full('S26-4459','Cooper, Bernard','Male','MRN-441029','1948-08-12','2026-02-21T09:30:00Z',
    ...
    'No residual melanoma — complete excision confirmed. Margins negative.',
    'No residual tumour (complete excision)','Not applicable','Not applicable (re-excision)','Negative, all margins >1 cm','Not identified',
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Elliptical skin re-excision from scalp measuring 5.8 × 4.2 cm with depth to galea aponeurotica. Central scar from previous biopsy identified.',
  ...
  full('S26-4460','Richardson, Loretta','Female','MRN-776843','1972-12-05','2026-02-25T09:00:00Z',
    ...
    'Not applicable','Not applicable','Not applicable','Not applicable',
    'Six grey-pink soft tissue cores each measuring 0.8–1.4 cm in length. Submitted in two cassettes.',
...
,
  ...
  full('S25-12346','Harrison, Marcus','Male','MRN-204471','1961-08-14','2026-03-10T08:00:00Z',
    ...
    'Received fresh is a left breast wide local excision weighing 48 g, measuring 9 × 7 × 3 cm with orienting sutures. Serial sectioning reveals a firm, white-tan stellate mass centrally located, measuring 1.8 × 1.4 × 1.2 cm, situated 4 mm from the deep margin.',
    'Sections show invasive ductal carcinoma of no special type (NST), Nottingham grade 2 (tubules 2, nuclei 2, mitoses 1; total score 5). Invasive tumour measures 1.8 cm. No lymphovascular invasion identified. All surgical margins clear; closest margin is deep at 4 mm. Sentinel lymph node (×1): no metastatic carcinoma identified (0/1, pN0). Associated DCIS, intermediate nuclear grade, present at periphery of invasive tumour.',
    'ER: 90% positive, Allred score 8 (strong). PR: 70% positive, Allred score 7 (moderate). HER2 IHC: 1+ negative. HER2 FISH: not amplified. Ki-67 proliferation index: 18%. AR (androgen receptor): 85% positive — standard finding in male breast carcinoma. Oncotype DX Recurrence Score recommended given ER+/HER2- profile.')
...
export function extractAiSynoptic(report: FullReport): AiExtractionResult {
  ...
  // ── Tumor size ──────────────────────────────────────────────────────────────
  const sizeMatch = (s.size ?? gross).match(/([\d.]+)\s*(?:×|x)\s*[\d.]+/i);
