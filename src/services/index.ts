...
import { MockVoiceMacroService } from './voicemacro/mockVoiceService';
import { GeminiAIIntegrationService } from './aiIntegration/GeminiAIIntegrationService';

// 2. Standard Service Exports (Existing Mocks)
...
// UPDATED: Renamed from shortcutService to actionRegistryService
...
// 3. SERVICE INSTANCES (Live Engines)
export const voiceMacroService = new MockVoiceMacroService();

// Initialize Gemini with API Key from environment
const GEMINI_API_KEY = import.meta.env.VITE_GEMINI_API_KEY || 'YOUR_API_KEY_HERE';
export const aiIntegrationService = new GeminiAIIntegrationService(GEMINI_API_KEY);
...
// UPDATED: Using the new Action Registry types
export type { SystemAction, IActionRegistryService } from './actionRegistry/IActionRegistryService';

export type { SystemConfig }      from './systemConfig/mockSystemConfigService';
export type { Macro }             from './macros/IMacroService';
export type { VoiceMacro }        from '../types/voiceMacros'; 
...
export type { Message, MessageThread }                                               from './messages/IMessageService';
export type { InternalNote, InternalNoteType, InternalNoteVisibility, NewInternalNote }              from './internalNotes/IInternalNoteService';
export { INTERNAL_NOTE_TYPE_LABELS }                                                     from './internalNotes/IInternalNoteService';

// AI Integration Types
export type { IAIIntegrationService, AIProcessingOptions } from './aiIntegration/IAIIntegrationService';
