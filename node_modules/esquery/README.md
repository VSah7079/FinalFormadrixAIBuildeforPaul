ESQuery is a library for querying the AST output by Esprima for patterns of syntax using a CSS style selector system. Check out the ***REMOVED***:

[***REMOVED***](https://estools.github.io/esquery/)
