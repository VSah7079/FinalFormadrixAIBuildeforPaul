...
For example, the following sets ***REMOVED***nstrate quadratic (`O(n^2)`) complexity:
...
Although these examples are clearly contrived, they ***REMOVED***nstrate how brace patterns can quickly grow out of control.
