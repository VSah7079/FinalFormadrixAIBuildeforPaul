 ...
 *   await readFile(new URL('./***REMOVED***.wasm', import.meta.url)),
 * );
 ...
 * ```
 *
 * To run the above example, create a new WebAssembly text format file named `***REMOVED***.wat`:
 *
 * ```text
 * (module
